...
export default function InvitedItem(props: Readonly<InvitedItemProps>) {
    return (
        <li className="flex justify-between bg-black/40 rounded-md px-6 py-3 border border-zinc-800">
            ...
            <div className="flex flex-col items-end">
                <span className="text-sm text-zinc-400">Fellows</span>
                <span className="text-lx font-bold">{props.guest.qtdFellows}</span>
            </div>
        </li>
    )
}